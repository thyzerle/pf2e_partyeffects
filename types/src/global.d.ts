...
import type {
  PF2ECONFIG,
  StatusEffectIconTheme,
} from '@scripts/config/index.ts';
...
declare global {
  ...
  interface ClientSettings {
    ...
    get(
      module: 'pf2e',
      setting: 'homebrew.languages'
    ): HomebrewTag<'languages'>[];
    get(
      module: 'pf2e',
    ...
    get(
      module: 'pf2e',
      setting: 'compendiumBrowserPacks'
    ): CompendiumBrowserSettings;
    get(
      module: 'pf2e',
      setting: 'compendiumBrowserSources'
    ): CompendiumBrowserSources;
    ...
    get(
      module: 'pf2e',
      setting: 'identifyMagicNotMatchingTraditionModifier'
    ): 0 | 2 | 5 | 10;
